...
export default function WebPLPWithFilterPage() {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-[58px] bg-white-A700 sm:gap-[29px]">
        ...
        <div className="flex flex-col items-center gap-[72px] md:gap-[54px] sm:gap-9">
          <div className="flex w-[58%] flex-col items-center gap-[19px] md:w-full">
            { <Text
              ...
              className="flex flex-wrap items-center justify-center text-gray-900 font-custom whitespace-nowrap text-ellipsis w-60 font-sans-serif font-medium"
            ...
            <div>
              <div className="flex items-start justify-between gap-5 border-b-[0.5px] border-solid border-gray-300 bg-white-A700 py-6 pr-6 sm:flex-col sm:py-5 sm:pr-5">
                ...
                <SelectBox
                  ...
                  className="mr-3 mt-[7px] w-[20%] gap-px font-bold uppercase text-right text-gray-900 sm:mr-0 sm:w-full sm:pr-5 "
                />
              </div>
            </div>
            <div className="flex items-start gap-4 md:flex-col">
              {isFilterVisible && (
                <div className="flex w-[24%] flex-col gap-[21px] md:w-full">
                      ...
                      {[...Array(8)].map((_, i) => (
                        <AccordionItem uuid={i} key={`expandablelisti${i}`}>
                          <div className="flex flex-1 flex-col gap-2">
                            ...
                            <AccordionItemPanel>
                              <div className="relative mt-[12px] flex w-[35%] flex-col items-start gap-[23px] md:w-full">
                                <Text
                                  size="lg"
                                  as="p"
                  ...
                  {["IDEAL FOR","OCCASION", "WORK", "FABRIC", "SEGMENT", "SUITABLE FOR", "RAW MATERIALS", "PATTERN"].map((section, i) => (
                    <AccordionItem uuid={i} key={`sectionlist-${i}`}>
                      <div className="flex flex-1 flex-col gap-2">
                        <AccordionItemHeading className="w-full">
                          <AccordionItemButton>
                            <AccordionItemState>
                        ...
                        <AccordionItemPanel>
                          <div className="relative mt-[12px] flex w-[35%] flex-col items-start gap-[23px] md:w-full">
                            ...
                            <CheckBox
                              name={`${section.toLowerCase()}_option1`}
                              label="Men (65)"
                              id={`${section.toLowerCase()}_option1`}
                              className="gap-2 p-px text-left text-base text-gray-900"
                            />
                            <CheckBox
                              name={`${section.toLowerCase()}_option2`}
                              label="Women (63)"
                              id={`${section.toLowerCase()}_option2`}
                              className="gap-2 p-px text-left text-base text-gray-900"
                            />
                            <CheckBox
                              name={`${section.toLowerCase()}_option3`}
                              label="Baby & Kids (59)"
                              id={`${section.toLowerCase()}_option3`}
                              className="gap-2 self-stretch text-left text-base text-gray-900"
                            />
                          </div>
                        </AccordionItemPanel>
                    ...
                    <div className="flex self-start bg-white-A700 pt-3.5">
                        <div className="flex flex-col items-start gap-0.5">
                          ...
                          <div className="flex items-center gap-[10px]">
                            <Text as="p" className="flex justify-between whitespace-nowrap mt-[-16px]">
                            <a href="/signin" className="underline text-blue_gray-400">
                                Sign in
                              </a>
      ...
      <Footer className="flex items-end justify-center self-stretch bg-black-900 p-5 sm:p-5 md:p-8 lg:p-10"/>
      {/*FOOTER SECTION END*/}
    </div>
  );
}
